...
//         if (docSnap.exists()) {
//           setAuditData(docSnap.data() as AuditData);
//         } else {
...
//     return (
//       <div className="min-h-screen bg-black flex items-center justify-center">
//         <div className="text-white text-xl">{error || "Audit not found"}</div>
//       </div>
//     );
//   }
...
//             Generated by AI Spend Audit Tool
//           </p>
//         </div>
//       </div>
//     </div>
